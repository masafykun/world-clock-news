    ...
    <AnimatePresence>
      {selected && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-[80] mx-auto w-full rounded-t-3xl bg-white/95 p-4 shadow-2xl ring-1 ring-slate-200 backdrop-blur sm:bottom-6 sm:max-w-[620px] sm:rounded-3xl sm:p-5"
        ...
        >
          <div className="flex gap-4">
            {/* アイコン */}
            <div
              className={`grid h-20 w-20 shrink-0 place-items-center rounded-2xl bg-gradient-to-br ${selected.gradient} text-4xl shadow-inner sm:h-24 sm:w-24 sm:text-5xl`}
              aria-hidden="true"
            >
              {selected.glyph}
            </div>
            ...
            <button
              ...
              className="self-start rounded-full p-2 text-slate-400 hover:bg-slate-100 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-pink-400"
              aria-label="詳細を閉じる"
            >
